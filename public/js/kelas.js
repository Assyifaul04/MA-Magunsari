$(document).ready(function () {
    ...
    $(document).on(
        "submit",
        'form[action*="kelas.store"], form[action*="kelas.update"]',
        function (e) {
            e.preventDefault();
    ...
    // Validasi real-time untuk nama kelas (tanpa minimal karakter)
    $(document).on("input", 'input[name="nama"]', function () {
        ...
        if (value.length === 0) {
            ...
            input.addClass("is-invalid");
            input.after(
                '<div class="invalid-feedback">Nama kelas maksimal 50 karakter!</div>'
            );
        } else {
