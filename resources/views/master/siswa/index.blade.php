                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <!-- Tombol Import Excel -->
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#importSiswaModal">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" class="text-primary fw-bold text-decoration-none" 
                                               data-bs-toggle="modal" data-bs-target="#scanRfidModal" 
                                               data-siswa-id="{{ $siswa->id }}" data-siswa-nama="{{ $siswa->nama }}"
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button type="button" class="btn btn-sm btn-outline-info editSiswaBtn" 
                                                    ...
                                                    data-kelas="{{ $siswa->kelas_id }}" data-rfid="{{ $siswa->rfid }}"
            ...
            <form action="{{ route('siswa.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="rfid_add" class="form-label">RFID <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-credit-card"></i></span>
                                    <input type="text" name="rfid" id="rfid_add" value="{{ old('rfid') }}" 
                                           class="form-control" required placeholder="Scan atau ketik RFID">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="status_add" class="form-label">Status <span class="text-danger">*</span></label>
                                <div class="input-group">
