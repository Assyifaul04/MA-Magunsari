    ...
    <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center">
            <img src="{{ asset('assets/img/profile-img.jpg') }}" alt="Profile"
                class="rounded-circle me-2 border shadow-sm" width="40" height="40">
            <div class="lh-sm">
        ...
        <!-- Dropdown -->
        <div class="dropdown">
            <a href="#" class="text-decoration-none text-muted" id="profileDropdown"
                data-bs-toggle="dropdown" aria-expanded="false">
                <i class="bi bi-three-dots-vertical fs-5"></i>
            </a>
            <!-- Tambahkan dropdown-menu-start supaya ke kiri -->
            <ul class="dropdown-menu dropdown-menu-start shadow rounded-3 border-0 mt-2"
